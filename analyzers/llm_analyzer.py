...
class LLMAnalyzer:
    """Analysiert Aktien-News mittels LLM (Claude oder Gemini, je nach LLM_PROVIDER)."""
    ...
    def _ollama_full_to_result(ticker: str, d: Dict) -> AnalysisResult:
        ...
        return LLMAnalyzer._enforce_buy_floor(AnalysisResult(
            ticker=ticker,
...
# Rückwärtskompat-Alias: Das Modul hieß früher analyzers.claude_analyzer und die
# Klasse ClaudeAnalyzer. Der Name ist provider-neutral geworden (Claude ODER
# Gemini), der alte Bezeichner bleibt für persistierte Provenance und externe
# Aufrufer gültig.
